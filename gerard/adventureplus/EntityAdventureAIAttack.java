...
public class EntityAdventureAIAttack extends EntityAIBase
{
    World worldObj;
    ...
    public EntityAdventureAIAttack(EntityLiving par1EntityLiving, Class par2Class, float par3, boolean par4)
    {
        this(par1EntityLiving, par3, par4);
        classTarget = par2Class;
    }

    public EntityAdventureAIAttack(EntityLiving par1EntityLiving, float par2, boolean par3)
    {
        attackTick = 0;
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            if(!attackedBefore)
            {
            	...
            	player.addChatMessage("Hey you! STOP!");
            	attackedBefore = true;
            }
